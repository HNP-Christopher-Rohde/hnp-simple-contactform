document.addEventListener("DOMContentLoaded", function() {
    var container = document.querySelector(".hnp_simple_contactform_wrap");
...
var cssCode = `
   .hnp_simple_contactform_wrap {
        position: relative;
    }
    
    .hnp_simple_contactform_wrap .hnp_lightbox {
        position: absolute;
        top: 0;
        left: 0;
        width: 100%;
    ...
    .hnp_simple_contactform_wrap .message {
